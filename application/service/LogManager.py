...
class LogManager(object):
    ...
    def log_set(self):
        ...
        Logger.log_info()
        Logger.log_info("song.selected_clip: %s" % SongFacade.selected_clip())
        if SongFacade.selected_clip():
            Logger.log_info()
            Logger.log_info("song.selected_clip.length: %s" % SongFacade.selected_clip().length)
            Logger.log_info()
            Logger.log_info("song.selected_clip.loop_start: %s" % SongFacade.selected_clip().loop_start)
            Logger.log_info("song.selected_clip.loop_end: %s" % SongFacade.selected_clip().loop_end)
