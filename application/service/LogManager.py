...
class LogManager(AbstractObject):
    ...
    def clear(self):
        # type: () -> None
        self.parent.log_info("clear_logs")
    ...
    def log_current(self):
        ...
        self.parent.log_info()
        self.parent.log_info("********* SELECTED_SCENE *************")
        self.parent.log_info()
        ...
        if self.song.current_track.instrument:
            self.parent.log_info("********* INSTRUMENT *************")
            self.parent.log_info()
            self.parent.log_info("current_track.instrument: %s" % self.song.current_track.instrument)
            self.parent.log_info()
    ...
    def log_set(self):
        ...
        self.clear()
        self.focus_window()
        self.parent.log_info("********* GLOBAL objects *************")
        ...
        self.parent.log_info()
        self.parent.log_info("********* SONG DATA *************")
        self.parent.log_info(self.song.get_data(list(SYNCHRONIZABLE_CLASSE_NAMES)[0]))
        self.parent.log_info()
        ...
        self.parent.log_info()
        self.parent.log_info("********* SONG SCENES *************")
        ...
        self.parent.log_info()
        self.parent.log_info("********* SELECTED_CLIP *************")
        self.parent.log_info()
