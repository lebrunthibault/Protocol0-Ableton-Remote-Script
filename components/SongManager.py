...
class SongManager(AbstractControlSurfaceComponent):
    def __init__(self, *a, **k):
        ...
        self._simple_track_to_external_synth_track = collections.OrderedDict()  # type: Dict[SimpleTrack, GroupTrack]
    ...
    def _map_tracks(self):
        ...
        self.song.group_tracks = [track for track in self.song.tracks if track.is_foldable]
        # link sub_tracks
